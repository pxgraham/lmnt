...
class Player {
  constructor(x, y, w, h, id) {
    ...
    this.update = () => {
      ...
      //this.testItemCollision
      for(let i in items) {
        let item = items[i];
        this.testItemCollision(item);
      }
  
      //this.testBulletCollision
      for(let j in this.target) {
      ...
      //updates player data to send to cli
      this.data = {
        id: this.id,
        x: this.x,
        y: this.y,
